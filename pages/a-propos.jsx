					...
					<div className="left-view">
						<ScrollAnimation animateIn="fadeIn" animateOnce delay={200}>
							<GithubStatsCard>
								...
								<div className="img">
									<Image src="/img/1724962994715.jpeg" alt={language.aboutMePage.alt_dev_img} layout="fill" objectFit="cover" className="image-rounded" />
								</div>
					...
					<div className="right-view">
						<ScrollAnimation animateIn="fadeIn" animateOnce delay={200}>
							...
							<div className="tech-and-cv">
								...
								<ButtonCV href="https://drive.google.com/file/d/12nRHN9ZhDxcwPw6iGRz2F5a92YQCdLp7/view?usp=sharing" target="_blank" data-splitbee-event="Download CV">
									Download CV
								</ButtonCV>
							</div>
						</ScrollAnimation>
